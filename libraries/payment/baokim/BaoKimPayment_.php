...
class BaoKimPayment 
{
	...
	private $baokim_url = 'http://kiemthu.baokim.vn/payment/order/version11';

	// Mã merchante site 
	private $merchant_id = '803';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = 'febaafb4a62bbcb8'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
		...
		, $url_detail)
	{
		...
		$params = array(
			...
			'business'			=>	'torai_132004@yahoo.com',
