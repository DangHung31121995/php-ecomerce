...
//		$next = "&rsaquo;";
		$next = "<img src='".URL_ROOT."/templates/default/images/page_next.gif' alt='previous page'>";
//		$first_page = "&#171; ";
		$first_page = "<img src='".URL_ROOT."/templates/default/images/page_first.gif' alt='first page'> ";
		$last_page = "<img src='".URL_ROOT."/templates/default/images/page_last.gif' alt='last page'>";
