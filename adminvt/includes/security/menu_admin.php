			...
			<tr>
				<td bgcolor="#ddf8cc">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td height="21" background="/templates/default/images/bg_title.jpg" class="module_name" style="cursor:pointer" onclick="show_menu('<?=$module_id?>')">&nbsp; <?=$module_name?></td>
							<td background="/templates/default/images/bg_title.jpg" style="padding:3px;" width="18"><img src="/templates/default/images/plus.gif" id="img_<?=$module_id?>" name="img_<?=$module_id?>" onclick="show_menu('<?=$module_id?>')" style="cursor:pointer" border="0"></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td>
					<div id="div_module_<?=$module_id?>" style="display:none">
						<table cellpadding="3" cellspacing="0" width="100%" border="0" bordercolor="#c5d7ef" style="border-collapse:collapse">
							...
							<tr>
								<td width="16" align="right"><img src="/templates/default/images/icon_cross.gif" hspace="0" vspace="2"></td>
