 ...
 * @final 21/04/2013
 */ 
class StaticsModelsStatics extends FSModels
{
    var $limit;
    var $prefix;
    function __construct()
    {
        $this->limit = 20;
        $this->view = 'statics';
        $this->table_category_name = 'fs_statics_categories';
        $this->table_types = 'fs_statics_types';
        ...
        $cmonth = date('m');
        $cday = date('d');
        $this->img_folder = 'images/statics/' . $cyear . '/' . $cmonth . '/' . $cday;
        $this->check_alias = 0;
