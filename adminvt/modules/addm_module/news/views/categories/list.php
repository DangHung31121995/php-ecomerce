<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('News categories') );
		...
		<div class="form-contents">
			<table border="1" class="tbl_form_contents" cellpadding="5">
				<thead>
					...
					<th class="title" width="7%">
						<?php echo  TemplateHelper::orderTable(FSText :: _('Home'), 'show_in_homepage',@$sort_field,@$sort_direct) ; ?>
					</th>
					<th class="title" width="7%">
					...
					<?php if(@$list){?>
						<?php foreach ($list as $row) { ?>
							...
							<tr class="row<?php echo $i%2; ?>">
								...
								<td><?php echo TemplateHelper::changeStatus("cb".($i),$row->show_in_homepage?"unhome":"home"); ?></td>
