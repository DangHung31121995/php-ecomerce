 ...
 * @final 21/04/2013
 */ 
class AboutModelsAbout extends FSModels
{
    var $limit;
    var $prefix;
    function __construct()
    {
        $this->limit = 20;
        $this->view = 'about';
        $this->table_category_name = 'fs_about_categories';
        $this->table_name = 'fs_about';
        ...
        $cmonth = date('m');
        $cday = date('d');
        $this->img_folder = 'images/about/' . $cyear . '/' . $cmonth . '/' . $cday;
        $this->check_alias = 0;
