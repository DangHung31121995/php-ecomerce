<?php  
global $toolbar;
$toolbar->setTitle(FSText :: _('Menu Item List') );
...
//	CONFIG	
$list_config = array();
$list_config[] = array('title'=>'Name','field'=>'treename','ordering'=> 1, 'type'=>'text','col_width' => '20%','align'=>'left');
$list_config[] = array('title'=>'Link','field'=>'link', 'type'=>'text','col_width' => '30%','align'=>'left');
...
TemplateHelper::genarate_form_liting($this->module,$this -> view,$list,$fitler_config,$list_config,'group_id','ASC',$pagination);
?>