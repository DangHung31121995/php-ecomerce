...
<div class="form_body">
	<form action="index.php?module=<?php echo $this -> module;?>&view=<?php echo $this -> view;?>" name="adminForm" method="post">
		...
		<div class="form-contents">
			<table border="1" class="tbl_form_contents" cellpadding="5" bordercolor="#CCC">
				<thead>
					...
					<th class="title">
						<?php echo  TemplateHelper::orderTable(FSText::_('Country'), 'c.name',@$sort_field,@$sort_direct) ; ?>
					</th>
					<th class="title">
						<?php echo  TemplateHelper::orderTable(FSText::_('City'), 'b.name',@$sort_field,@$sort_direct) ; ?>
					</th>
		...
		<input type="hidden" value="<?php echo 'name,ordering';?>" name="field_change"> 		<!--	<== CONFIG	-->
