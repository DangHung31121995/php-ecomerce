...
<div class="form_body">
	<form class="form-contents" action="index.php?module=<?php echo $this -> module;?>&view=<?php echo $this -> view;?>" name="adminForm" method="post" enctype="multipart/form-data">
		<fieldset>
			...
			<div id="tabs">
				<br/>
				<p class="notice">Tên bảng chỉ chứa các : Chữ cái thường, số ,gạch dưới. Tránh các bảng đặc biệt gồm : <strong>tables,categories,filters,fields_groups</strong>
				</p>
				<br/>
				<table>
					<tr>
		...
		<fieldset>
			...
			<div id="tabs">
		    	<p class="notice">Tên trường chỉ chứa các : Chữ cái, số ,gạch dưới. Không đặt tên trường là: <strong><?php echo $str_field_default; ?></strong>
		    	</p>
		    	<br/>
								...
								<tr id="extend_field_exist_<?php echo $i; ?>">
									...
									<td class="right_col">
										<select name='ftype_exist_<?php echo $i;?>' class='ftype_exist' id='ftype_exist_<?php echo $i;?>' onchange="javascript: change_ftype(this);" >
											...
											<option value="foreign_one" <?php echo  $field->field_type == "foreign_one" ? "selected=\"selected\"":""; ?>>Foreign One </option>
											<option value="foreign_multi" <?php echo  $field->field_type == "foreign_multi" ? "selected=\"selected\"":""; ?>>Foreign Multi </option>
										</select>
...
<script>
	...
	function   addField()
	{
		...
		htmlString += "<option value=\"foreign_one\" >Foreign One</option>";
		htmlString += "<option value=\"foreign_multi\" >Foreign Multi</option>";
		htmlString += "</select>";
		htmlString += "</td>";
		// foreign_data
		htmlString += "<td>";
