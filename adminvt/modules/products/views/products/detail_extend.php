<?php
// biến cho trường hợp mở rộng đặc biệt
$object_shoes_size = null; 
if(@$extend_fields) {
?>
<table>
    <?php 
    ...
    {
    	if($extend_fields[$i] -> table_name == 'fs_products_giay_tennis' && $extend_fields[$i] -> field_name == 'size_giay') {
            $object_shoes_size = $extend_fields[$i];
    	}
