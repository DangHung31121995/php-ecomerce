...
<div class="form_body">
	...
	<form class="form-contents" action="index.php?module=<?php echo $this -> module; ?>" name="adminForm" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" value="<?php echo count($filters); ?>" name="filter_exist_total" id="filter_exist_total" />
...
//		htmlString +=  "<input type=\"text\" name='alias_new_"+i+"' id='alias_new_"+i+"'  />";
	...
	{
		field = $('#field').val();
		window.location = "index.php?module=products&view=filters&tablename=<?php echo $tablename?>&field="+field;
