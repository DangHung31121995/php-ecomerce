<div class="tbpopup-title">
    Ngành hàng <?php echo $arrIndustries[$id] ?> - Quý <?php echo $quarter ?> - <?php echo $arrProgram[$program] ?>
...
<div class="tbpopup-content">
    ...
    <table id="tbl-report-city" class="data-table" style="table-layout: fixed; width: 505px; border: 1px solid #a1aebc !important; float: left;">
        <tr>
            ...
            <td>
                ...
                <div><a class="a-report" href="#"><?php echo FSText::_('Xem') ?></a> <?php echo FSText::_('3 tỉnh tốt nhất') ?></div>
    ...
    <div style="display: inline-block; float: left; margin-left: 10px;">
        <div id="statistics_industries" class="sys-chart" style="width: 655; height: 513px; border: 1px solid #dddddd;"></div>
        <script type="text/javascript">
        $(document).ready(function(){
            $.ajax({
        		type : 'POST',
                dataType: 'json',
        		url : '/index.php?module=statistics&view=program&raw=1&task=get_statistics_by_industry',
                data: {'id': <?php echo $id ?>, 'quarter': '<?php echo $quarter ?>'},
                success : function($json){
                    $('#statistics_industries').highcharts({
                        chart: {
                            type: 'column'
                        },
                        title: {
                            text: '<?php echo FSText::_('Biểu đồ số doanh nghiệp tham gia hoạt động trong và ngoài chương trình tỉnh Ngành')?> <?php echo $arrIndustries[$id] ?>'
                        },
                        subtitle: {
