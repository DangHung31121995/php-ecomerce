...
<div class="tbpopup-content">
    <table class="tbl-tmp" style="table-layout: fixed; margin: 0 auto;">
        ...
        <tr>
            <td colspan="3">
                <a id="excel_link" href="<?php echo FSRoute::_('index.php?module=statistics&view=program&raw=1&task=excel_list_program&program=1&start_date='.date('d/m/Y', strtotime(OPERATING_SYSTEM)).'&finish_date='.date('d/m/Y')) ?>" class="export excel" title="Xuất ra Excel">Xuất ra Excel</a>
            </td>
        </tr>
     </table>
...
function changeExcelLink(){
    ...
    $link = 'index.php?module=statistics&view=program&raw=1&task=excel_list_program&program='+$program+'&start_date='+$start_date+'&finish_date='+$finish_date;
