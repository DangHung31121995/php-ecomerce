<div class="tbpopup-title">
    <?php echo $arrRegions[$id] ?> - Quý <?php echo $quarter ?> - <?php echo $arrProgram[$program] ?>
    ...
    <div style="display: inline-block; float: left; margin-left: 10px;">
        ...
        $(document).ready(function(){
            $.ajax({
        		type : 'POST',
                dataType: 'json',
        		url : '/index.php?module=statistics&view=program&raw=1&task=get_statistics_by_region',
                ...
                success : function($json){
                    $('#statistics_industries').highcharts({
                        ...
                        title: {
                            text: '<?php echo FSText::_('Biểu đồ số doanh nghiệp tham gia hoạt động trong và ngoài chương trình tỉnh ')?> <?php echo $arrRegions[$id] ?>'
                        },
                        subtitle: {
