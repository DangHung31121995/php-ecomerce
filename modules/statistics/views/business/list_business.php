...
<div class="content-inner clearfix">
    ...
    <table class="data-table" style="width:1000px; table-layout: fixed;">
        <tr class="bg-yellow white">
            ...
            <td style="width: 125px;" class="bold center"><?php echo FSText::_('Xem'); ?></td>
        </tr>
        <?php 
        $i = 0;
        ...
        ?>
            <tr>
                ...
                <td class="center"><a class="view" href="/index.php?module=statistics&view=business&task=view&id=<?php echo $item->id ?>"><?php echo FSText::_('Xem'); ?></a></td>
            </tr>
        <?php } ?>
    </table>
